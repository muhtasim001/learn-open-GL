...
void display (GLFWwindow * window, double current_time) {
    ...
    //make a loop and have 24 cubes 
    for (int i = 0; i < 200; i++) {
        float tf = current_time + i;

        //use the model matrix with varrying translation and rotation using time
        glm::mat4 tMat, rMat;
...
int main (void) {
    ...
    GLFWwindow * window = glfwCreateWindow(1280, 720, "program_4.1 animated", NULL, NULL);
